...
background: transparent;
  ...
  body {
    background-image: url(http://ux.nearsoft.com/wp/wp-content/themes/ux/img/travel.png);
    background-size: cover;
...
<div class="verify-center">
  <h2>Webinar: Validate Your Product with Usability Testingy</h2>
<!--
...
<script>
var end = new Date('12/08/2016 11:00 AM');
